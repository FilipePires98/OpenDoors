...
public class Fragment_Livestream_Employees extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_livestream_employees, null);
        ...
        JsonArrayRequest objectRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        Log.d("onResponseEmployee", response.toString());
                        ...
                        for (int i = 0 ; i < response.length(); i++) {
                            ...
                            try {
                                ...
                                //TODO
                                //FAZER CORRETAMENTE O PROCESSAMENT
                        ...
                        LineDataSet set1 = new LineDataSet(yValues, "Variação da tempo sentado(employee) ao longo do tempo");
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Log.d("onErrorEmployee", error.toString());
